...
namespace _2._1
{
    ...
    public class MyList
    {
        ...
        public virtual bool Add(int position, double data)
        {
        ...
        public virtual bool Add(double data)
        {
        ...
        public double DataGet(int position)
        {
            if (!Correct(position))
            {
                return 0;
        ...
        public virtual bool Dataset(int position, double data)
        {
            if (!Correct(position))
            {
                return false;
        ...
        public bool DeleteByData(double data)
        {
            if (!Count(data))
            {
